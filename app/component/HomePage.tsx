      ...
      mx-auto px-8 py-12 flex flex-col items-center justify-center  mt-8"
        >
          ...
          <p className="max-w-[50%] sm:text-start mx-auto text-center text-sm tracking-widest text-gray-600 py-4 ">
            ...
            developer.i&apos;m open for learning new things and also working
            with a team across the continent,while pushing my carrier in
            frontend i&apos;m also learning backend for future purposes
          </p>
